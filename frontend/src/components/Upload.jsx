    ...
    <>
      <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-40">
        <div className="relative bg-white dark:bg-gray-900 rounded-2xl shadow-xl w-[600px] max-h-[90vh] overflow-y-auto p-6">
          <h3 className="text-xl font-semibold text-gray-800 dark:text-white">Upload CSV or Excel File</h3>
          ...
          <div className="flex justify-end mt-6">
            <button
              onClick={handleSubmitData}
              className={`px-5 py-2 rounded-lg shadow transition duration-200 ${
                loading ? "bg-gray-500 text-white cursor-not-allowed" : "bg-blue-600 text-white hover:bg-blue-700"
              }`}
              disabled={loading}
            >
